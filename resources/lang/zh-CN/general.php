...
return [
    ...
    'accepted_date'         => '接受日期',
    'accessory'				=> '配件',
    'accessory_report'		=> '配件报表',
    'action'                => '操作',
    'activity_report'		=> '活动报表',
    'address'				=> '地址',
    'admin'					=> '管理员',
    ...
    'customize_report'      => '自定义报表',
    'custom_report'         => '自定义资产报表',
    'dashboard'				=> '概况',
    'days'      			=> '天数',
    'days_to_next_audit'    => '距离最近一次盘点的天数',
    'date'					=> '日期',
    'debug_warning'         => '警告!',
    ...
    'importing'         	=> '正在导入…',
    'importing_help'        => '您可以通过CSV文件导入资产、配件、许可证、组件、耗材和用户。 <br><br>CSV 应以逗号分隔和格式化，并且在文档</a> 中与 <a href="https://snipe-it.readme.io/docs/importing" target="_new">样本CSV中的标头匹配。',
    ...
    'total_assets'			=> '资产数量',
    'total_licenses'		=> '许可证数量',
    'total_accessories'		=> '配件数量',
    'total_consumables'		=> '耗材数量',
    'type'  				=> '类型',
    'undeployable'			=> '无法被分配',
    'unknown_admin'			=> '未知管理员',
    ...
    'login_enabled'         => '登录已启用',
    'audit_due'             => '到期盘点',
    'audit_due_days'        => '在:天内到期的资产 |应在:天内盘点的资产',
    'checkin_due'           => '到期签入',
    ...
    'changed'               => '已修改',
    'to'                    => '至',
    'report_fields_info'    => '<p>选择您想要在自定义报表中包含的字段，然后单击生成. 该文件(custom-asset-report-YYYY-mm-dd.csv)将自动下载，您可以使用 Excel打开它。</p>
